...
<div className='header'>
    ...
    <div className='header-links'>
        ...
        <UserContext.Consumer>
            {value=> !value.user && <Link href='/login'><Button basic color='black' size='large' style={{fontWeight:'bold'}}>Přihlásit se</Button></Link>}
        </UserContext.Consumer> 
        <UserContext.Consumer>
            {value=> value.user && <Button onClick={value.logout} basic color='black' size='large' style={{fontWeight:'bold'}}>Odhlásit se</Button>}
        </UserContext.Consumer> 
    </div>
</div>
